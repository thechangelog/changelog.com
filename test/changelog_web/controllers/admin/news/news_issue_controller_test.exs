defmodule ChangelogWeb.Admin.NewsIssueControllerTest do
  ...
  test "requires user auth on all actions", %{conn: conn} do
    Enum.each([
      ...
      get(conn, admin_news_issue_path(conn, :edit, "123")),
      put(conn, admin_news_issue_path(conn, :update, "123"), news_issue: @valid_attrs),
      delete(conn, admin_news_issue_path(conn, :delete, "123")),
    ], fn conn ->
