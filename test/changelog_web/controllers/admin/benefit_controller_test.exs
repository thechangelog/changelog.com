defmodule ChangelogWeb.Admin.BenefitControllerTest do
  ...
  test "lists all benefits on index", %{conn: conn} do
    ...
    conn = get(conn, Routes.admin_benefit_path(conn, :index))
  ...
  test "renders form to create new benefit", %{conn: conn} do
    conn = get(conn, Routes.admin_benefit_path(conn, :new))
  ...
  test "does not create with invalid attributes", %{conn: conn} do
    ...
    conn = post(conn, Routes.admin_benefit_path(conn, :create), benefit: @invalid_attrs)
  ...
  test "renders form to edit benefit", %{conn: conn} do
    ...
    conn = get(conn, Routes.admin_benefit_path(conn, :edit, benefit))
  ...
  test "deletes a benefit and redirects", %{conn: conn} do
    ...
    conn = delete(conn, Routes.admin_benefit_path(conn, :delete, benefit.id))
