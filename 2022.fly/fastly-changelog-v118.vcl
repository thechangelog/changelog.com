...
backend F_fly_2022_03_13 {
    ...
    .ssl = true;
    .ssl_cert_hostname = "changelog-2022-03-13.fly.dev";
    .ssl_check_cert = always;
    .ssl_sni_hostname = "changelog-2022-03-13.fly.dev";

    .probe = {
        .expected_response = 200;
        .initial = 1;
        .interval = 60s;
        .request = "GET /health HTTP/1.1" "Host: changelog-2022-03-13.fly.dev" "Connection: close" "User-Agent: Varnish/fastly (healthcheck)";
        .threshold = 1;
        .timeout = 5s;
        .window = 2;
      }
...
set req.backend = F_fly_2022_03_13;
if (req.http.cookie) {
...
if (req.url.ext ~ "(?i)^(png|jpe?g)$") {
  ...
  #end condition
  # Request Condition: changelog.com host Prio: 10
  if( req.http.host == "changelog.com" ) {
