defmodule ChangelogWeb.Meta.Twitter do
  ...
  alias ChangelogWeb.{Endpoint, EpisodeView, PageView, PodcastView, PostView,
                      Router.Helpers}

  def twitter_card_type(%{view_module: EpisodeView, view_template: "show.html"}), do: "player"
  def twitter_card_type(%{view_module: PageView, view_template: "ten.html"}), do: "summary_large_image"
  def twitter_card_type(%{view_module: PodcastView}), do: "summary_large_image"
  def twitter_card_type(%{view_module: PostView, post: %{image: img}}) when is_map(img), do: "summary_large_image"
