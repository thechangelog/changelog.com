defmodule ChangelogWeb.Admin.SponsorView do
  ...
  def list_of_links(sponsor) do
    [
      %{value: sponsor.twitter_handle, icon: "twitter", url: SharedHelpers.twitter_url(sponsor.twitter_handle)},
      %{value: sponsor.github_handle, icon: "github", url: SharedHelpers.github_url(sponsor.github_handle)},
