defmodule ChangelogWeb.FeedView do
  ...
  def render_item(item = %{object: nil}, assigns), do: render("_news.xml", Map.put(assigns, :item, item))
  ...
  def render_title(item = %{object: nil}, assigns), do: render("_news_title.xml", Map.put(assigns, :item, item))
