defmodule Changelog.SponsorStyle do
  def all do
    [
      ...
      %{type: "Partner pre-roll", name: "Rollbar, Network-wide pre-roll sponsorship", audio: "https://changelog-assets.s3.amazonaws.com/partner-stories/rollbar-partner-preroll-move-fast-and-fix-things.mp3", duration: 5},
      ...
      %{type: "Partner Pre-roll", name: "Fastly, Network-wide pre-roll sponsorship", audio: "https://changelog-assets.s3.amazonaws.com/partner-stories/fastly-preroll.mp3", duration: 06}
    ]
  end
end
