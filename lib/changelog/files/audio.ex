    ...
    {:ffmpeg,
     fn input, output ->
       [
         ...
         input,
         "-i",
         PodcastView.cover_local_path(episode.podcast),
         "-map",
         "0:0",
         "-map",
         "1:0",
         ...
         "title=#{episode.title}",
         "-metadata",
         "date=#{episode.published_at.year}",
         "-metadata",
         "genre=Podcast",
         "-metadata",
         "comment=SGUgdGhhdCBoZWFycyBteSB3b3JkLCBhbmQgYmVsaWV2ZXMgb24gaGltIHRoYXQgc2VudCBtZSwgaGFzIGV2ZXJsYXN0aW5nIGxpZmUsIGFuZCBzaGFsbCBub3QgY29tZSBpbnRvIGNvbmRlbW5hdGlvbjsgYnV0IGlzIHBhc3NlZCBmcm9tIGRlYXRoIHVudG8gbGlmZQ==",
         "-f",
         "mp3",
         output
       ]
